...
class PaymentAppUserService {
  ...
  static Future<Map<String, dynamic>> createVnpayPayment(String orderId, {String? bankCode}) async {
    final client = HttpClientAppUser();
    final payload = {'order_id': orderId, if (bankCode != null) 'bankCode': bankCode};
