...
const mockNotifications: Notification[] = [
  ...
  },
  {
    ...
    content:
      "Đặt bàn #123 cho khách hàng Nguyễn Văn A đã được xác nhận cho 19:00 hôm nay",
  ...
  },
  {
    ...
    content:
      "Giảm 20% cho tất cả món ăn vào cuối tuần. Áp dụng từ thứ 6 đến chủ nhật.",
  ...
  },
  {
    ...
    content:
      "Hệ thống sẽ được bảo trì vào 2:00 AM ngày mai. Dự kiến hoàn thành trong 1 giờ.",
    recipient_type: "all",
    sent_at: "2024-03-19T10:00:00",
          ...
          {filteredNotifications.map((notification) => (
            ...
            >
              <div className="flex justify-between items-start mb-2">
                <div className="flex items-center gap-2">
                  ...
                  >
                    ...
                    {notification.type === "reservation_confirm" &&
                      "Xác nhận đặt bàn"}
                ...
                <span className="text-sm text-gray-500">
                  {new Date(
                    notification.sent_at || notification.scheduled_at || ""
              ...
              <div className="flex justify-between items-center text-sm text-gray-500">
                ...
                <span>
                  Đã đọc: {notification.read_count}/
