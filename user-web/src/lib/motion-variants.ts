...
/**
 * Motion Variants for HIWELL Restaurant
 * Luxury, smooth, and elegant animations
 */
...
// Viewport-based animation (only animate when in view)
...
// Stagger delay function for lists
