          ...
          <div className="flex items-center justify-between h-16">
            <div className="flex items-center space-x-4">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">Xem trạng thái và tiến độ đơn hàng của bạn</p>
              </div>
            </div>
          ...
          <div className="fixed inset-0 bg-background/80 backdrop-blur-sm z-50 flex items-center justify-center p-4">
            <Card className="max-w-md w-full">
              <CardHeader>
                ...
                <CardDescription>Bạn có chắc chắn muốn hủy đơn hàng này không?</CardDescription>
              </CardHeader>
              <CardContent className="space-y-4">
                ...
                <Alert>
                  ...
                  <AlertDescription>Đơn hàng đã bắt đầu chế biến có thể không được hoàn tiền 100%.</AlertDescription>
                </Alert>
                <div className="flex space-x-3 justify-end">
                  <Button variant="outline" onClick={() => setShowCancelDialog(null)}>
                    Không hủy
                  </Button>
                  <Button variant="destructive" onClick={() => handleCancelOrder(showCancelDialog)}>
                    Xác nhận hủy
                  </Button>
                </div>
              </CardContent>
