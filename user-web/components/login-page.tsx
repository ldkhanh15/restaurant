    ...
    <div className="min-h-screen bg-background flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          <Button variant="ghost" onClick={() => navigate("home")} className="absolute top-4 left-4 md:top-8 md:left-8">
          ...
          <div className="flex items-center justify-center space-x-3 mb-6">
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground">Trải nghiệm ẩm thực đẳng cấp</p>
            </div>
          </div>
        </div>
        ...
        <Card className="border-2 shadow-xl">
          ...
          <CardContent>
            ...
            <div className="mt-8 p-4 bg-muted/50 rounded-lg">
              ...
              <p className="text-xs text-muted-foreground mb-1">Email: demo@restaurant.com</p>
