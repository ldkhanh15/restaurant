...
Employee.hasMany(InventoryImport, {
  foreignKey: "employee_id",
  as: "inventoryImports",
});
InventoryImport.belongsTo(Employee, {
  foreignKey: "employee_id",
  as: "employee",
});

Supplier.hasMany(InventoryImport, {
  foreignKey: "supplier_id",
  as: "inventoryImports",
});
InventoryImport.belongsTo(Supplier, {
  foreignKey: "supplier_id",
  as: "supplier",
});
...
Ingredient.hasMany(InventoryImportIngredient, {
  foreignKey: "ingredient_id",
  as: "imports",
});
...
TableGroup.hasMany(Reservation, {
  foreignKey: "table_group_id",
  as: "reservations",
});
Reservation.belongsTo(TableGroup, {
  foreignKey: "table_group_id",
  as: "tableGroup",
});
...
Reservation.hasMany(EventBooking, {
  foreignKey: "reservation_id",
  as: "eventBookings",
});
EventBooking.belongsTo(Reservation, {
  foreignKey: "reservation_id",
  as: "reservation",
});
